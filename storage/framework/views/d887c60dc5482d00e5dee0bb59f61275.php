<?php $__env->startSection('title', 'Beranda - PSSI Gianyar'); ?>
...
<div class="relative min-h-screen md:h-[85vh] flex items-center justify-center overflow-hidden pt-24 md:pt-0">
    ...
    <div class="relative z-10 text-center px-4 max-w-5xl mx-auto mt-0 md:mt-10">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center items-center w-full px-4 sm:px-0">
            <a href="<?php echo e(route('clubs.index')); ?>" class="w-full sm:w-auto group relative px-8 py-4 bg-red-600 hover:bg-red-700 text-white font-heading font-bold uppercase tracking-widest md:-skew-x-12 transition-all hover:scale-105 shadow-[0_0_20px_rgba(220,38,38,0.5)] text-center">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-y-8 md:gap-8 text-center md:divide-x divide-white/5">
            ...
            <div class="group">
                ...
                <span class="block text-3xl md:text-5xl font-heading font-bold text-white mb-2 group-hover:text-red-600 transition">
                    <?php echo e(\App\Models\Club::count() ?? '18'); ?>
...
<div class="py-12 md:py-20 bg-black">
    <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            ...
            <article class="bg-zinc-900 group cursor-pointer border border-zinc-800 hover:border-red-600/50 transition duration-300 rounded-lg md:rounded-none overflow-hidden">
                ...
                <div class="p-6">
                    <span class="text-red-500 text-[10px] font-bold uppercase tracking-widest mb-2 block">Regulasi</span>
                    <h3 class="text-xl font-bold text-white mb-3 group-hover:text-red-500 transition line-clamp-2">Pendaftaran Klub Liga 2026 Resmi Dibuka</h3>
                    <p class="text-zinc-400 text-sm leading-relaxed mb-4 line-clamp-3">PSSI Gianyar membuka pendaftaran klub untuk musim kompetisi tahun depan. Segera lengkapi administrasi.</p>
                    <span class="text-zinc-600 text-[10px] uppercase font-bold">Admin PSSI • 2 Jam Lalu</span>
                </div>
            </article>
            ...
            <article class="bg-zinc-900 group cursor-pointer border border-zinc-800 hover:border-red-600/50 transition duration-300 rounded-lg md:rounded-none overflow-hidden">
                ...
                <div class="p-6">
                    <span class="text-red-500 text-[10px] font-bold uppercase tracking-widest mb-2 block">Matchday</span>
                    <h3 class="text-xl font-bold text-white mb-3 group-hover:text-red-500 transition line-clamp-2">Jadwal Pertandingan Pekan Pertama</h3>
                    <p class="text-zinc-400 text-sm leading-relaxed mb-4 line-clamp-3">Cek jadwal lengkap pertandingan pembuka liga yang akan diselenggarakan di Stadion Dipta.</p>
                    <span class="text-zinc-600 text-[10px] uppercase font-bold">Admin PSSI • 1 Hari Lalu</span>
                </div>
            </article>
            ...
            <article class="bg-zinc-900 group cursor-pointer border border-zinc-800 hover:border-red-600/50 transition duration-300 rounded-lg md:rounded-none overflow-hidden">
                ...
                <div class="p-6">
                    <span class="text-red-500 text-[10px] font-bold uppercase tracking-widest mb-2 block">Transfer</span>
                    <h3 class="text-xl font-bold text-white mb-3 group-hover:text-red-500 transition line-clamp-2">Bursa Transfer Pemain Resmi Ditutup</h3>
                    <p class="text-zinc-400 text-sm leading-relaxed mb-4 line-clamp-3">Setiap klub wajib mendaftarkan minimal 18 pemain dan maksimal 30 pemain.</p>
                    <span class="text-zinc-600 text-[10px] uppercase font-bold">Admin PSSI • 3 Hari Lalu</span>
                </div>
            </article>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH H:\pssi_gianyar\resources\views/welcome.blade.php ENDPATH**/ ?>