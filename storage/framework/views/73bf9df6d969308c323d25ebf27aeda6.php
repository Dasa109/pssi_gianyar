...
<?php $__env->startSection('title', 'Login Pemain - PSSI Gianyar'); ?>
...
<div class="min-h-screen flex items-center justify-center bg-black py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
    ...
    <div class="max-w-md w-full space-y-8 relative z-10 bg-zinc-900/80 backdrop-blur-xl p-8 rounded-2xl border border-white/10 shadow-[0_0_50px_rgba(0,0,0,0.5)]">
        ...
        <form class="mt-8 space-y-6" action="<?php echo e(route('player.login.submit')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div class="text-center mt-6">
                <p class="text-sm text-zinc-400">
                    ...
                    <a href="<?php echo e(route('player.register')); ?>" class="font-bold text-red-500 hover:text-red-400 transition underline decoration-red-500/30 hover:decoration-red-500">
                        Daftar Disini
                    </a>
                </p>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH H:\pssi_gianyar\resources\views/player/auth/login.blade.php ENDPATH**/ ?>