...
<body class="bg-slate-50 text-slate-800 bali-pattern min-h-screen py-10 px-4">
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
            ...
            <a href="<?php echo e(route('player.dashboard')); ?>" class="group flex items-center gap-2 bg-white px-5 py-2.5 rounded-xl text-sm font-bold text-slate-700 shadow-sm border border-slate-200 hover:border-red-500 hover:text-red-600 transition">
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" value="<?php echo e($player->name); ?>" disabled class="w-full bg-slate-50 border border-slate-200 rounded-lg px-4 py-2 text-slate-600 cursor-not-allowed">
                            </div>
                            <div>
                                <label class="block text-xs font-bold text-slate-400 uppercase tracking-wider mb-1">Email Login</label>
                                <input type="text" value="<?php echo e($player->email); ?>" disabled class="w-full bg-slate-50 border border-slate-200 rounded-lg px-4 py-2 text-slate-600 cursor-not-allowed">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="mt-12 text-center">
            <p class="text-slate-400 text-xs">
                &copy; <?php echo e(date('Y')); ?> PSSI Kabupaten Gianyar. Keamanan data Anda adalah prioritas kami.
            </p>
        </div>
