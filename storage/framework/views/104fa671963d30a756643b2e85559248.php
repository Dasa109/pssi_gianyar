...
<head>
    ...
    <title>Edit Profil - <?php echo e($player->name); ?></title>
...
<body class="bg-slate-50 text-slate-800 bali-pattern min-h-screen flex flex-col">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <div class="flex items-center gap-3">
                    <a href="<?php echo e(route('player.dashboard')); ?>" class="flex items-center gap-3 group">
    ...
    <main class="flex-grow max-w-4xl mx-auto w-full px-4 py-8">
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden relative">
            ...
            <form action="<?php echo e(route('player.update')); ?>" method="POST" enctype="multipart/form-data" class="p-8">
                <?php echo csrf_field(); ?>
                ...
                <div class="flex items-center gap-6 mb-8 -mt-16 relative z-20">
                    <div class="relative group">
                        <img id="preview_photo" 
                             src="<?php echo e($player->photo ? asset('storage/' . $player->photo) : 'https://ui-avatars.com/api/?name='.urlencode($player->name).'&background=random'); ?>" 
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" value="<?php echo e(old('name', $player->name)); ?>" class="w-full px-4 py-3 rounded-lg border border-slate-200 focus:border-red-500 focus:ring-2 focus:ring-red-200 transition bg-slate-50 focus:bg-white text-slate-800 font-medium">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <select name="position" class="w-full px-4 py-3 rounded-lg border border-slate-200 focus:border-red-500 focus:ring-2 focus:ring-red-200 transition bg-slate-50 focus:bg-white text-slate-800 font-medium appearance-none">
                                <option value="GK" <?php echo e($player->position == 'GK' ? 'selected' : ''); ?>>Kiper (GK)</option>
                                <option value="DEF" <?php echo e($player->position == 'DEF' ? 'selected' : ''); ?>>Belakang (DEF)</option>
                                <option value="MID" <?php echo e($player->position == 'MID' ? 'selected' : ''); ?>>Tengah (MID)</option>
                                <option value="FWD" <?php echo e($player->position == 'FWD' ? 'selected' : ''); ?>>Depan (FWD)</option>
                            </select>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$player->club_id): ?>
                    <div class="md:col-span-2">
                        <label class="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">Klub Asal (Manual)</label>
                        <input type="text" name="club_dummy" value="<?php echo e(old('club_dummy', $player->club_dummy)); ?>" class="w-full px-4 py-3 rounded-lg border border-slate-200 focus:border-red-500 focus:ring-2 focus:ring-red-200 transition bg-slate-50 focus:bg-white text-slate-800 font-medium">
    ...
    <script>
        ...
        <?php if($errors->any()): ?>
            Swal.fire({
                ...
                html: '<ul class="text-left text-sm list-disc pl-5"><?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><li><?php echo e($error); ?></li><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></ul>',
                icon: 'error',
                confirmButtonColor: '#b91c1c'
            });
        <?php endif; ?>
...
</html><?php /**PATH H:\pssi_gianyar\resources\views/player/edit.blade.php ENDPATH**/ ?>