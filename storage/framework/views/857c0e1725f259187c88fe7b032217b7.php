...
<div class="relative h-[400px] md:h-[500px] bg-zinc-950 flex items-center justify-center overflow-hidden border-b border-white/5">
    ...
    <div class="relative z-10 text-center px-4 flex flex-col items-center mt-10">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($club->stadium): ?>
            <div class="inline-flex items-center gap-2 bg-red-600/10 border border-red-600/30 px-6 py-2 rounded-full backdrop-blur-md">
                ...
                <span class="text-red-100 font-bold tracking-widest uppercase text-xs md:text-sm"><?php echo e($club->stadium); ?></span>
            </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>
</div>
                    ...
                    <div class="space-y-5">
                        ...
                        <div class="pb-2">
                            ...
                            <p class="text-zinc-300 text-sm leading-relaxed bg-zinc-900/50 p-3 rounded border border-white/5">
                                <?php echo e($club->address ?? 'Alamat belum tersedia.'); ?>
        ...
        <div class="lg:col-span-8 space-y-12">
            <div class="bg-zinc-800/30 p-8 rounded-2xl border border-white/5">
                ...
                <div class="prose prose-invert prose-red max-w-none text-zinc-400 leading-loose">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($club->history): ?>
                        <?php echo $club->history; ?>
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8 pt-8 border-t border-white/5">
                    ...
                    <div class="text-center">
                        ...
                        <span class="block text-3xl font-bold text-white mb-1"><?php echo e($club->players->count()); ?></span>
            ...
            <div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($club->players && $club->players->count() > 0): ?>
