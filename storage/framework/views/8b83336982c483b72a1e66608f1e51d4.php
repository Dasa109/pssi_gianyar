...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="relative">
                        <input name="club_dummy" type="text" value="<?php echo e(old('club_dummy')); ?>"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="text-center mt-4">
                <p class="text-sm text-zinc-400">
                    Sudah punya akun? 
                    <a href="<?php echo e(route('player.login')); ?>" class="font-medium text-red-500 hover:text-red-400 underline">
                        Login disini
                    </a>
                </p>
            </div>
