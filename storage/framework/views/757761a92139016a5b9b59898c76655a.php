            ...
            <div class="flex flex-wrap items-center justify-between py-4">
                ...
                <div class="flex gap-4">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::guard('player')->check()): ?>
                        <a href="<?php echo e(route('player.dashboard')); ?>" class="px-5 py-2 text-xs font-bold uppercase tracking-widest border border-green-600 text-green-500 hover:bg-green-600 hover:text-white transition -skew-x-12 flex items-center gap-2">
                            <span class="skew-x-12 block">
                                <span class="hidden sm:inline">Hi, <?php echo e(Str::limit(Auth::guard('player')->user()->name, 8)); ?> | </span> Dashboard
                            </span>
                        </a>
                    <?php else: ?>
                        <a href="<?php echo e(route('player.login')); ?>" class="px-5 py-2 text-xs font-bold uppercase tracking-widest border border-red-600 text-red-600 hover:bg-red-600 hover:text-white transition -skew-x-12">
